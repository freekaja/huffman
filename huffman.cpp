...
int main (){
  ...
  ifstream ifs {inname};
  assert(ifs && "can't open input file");

  //read file contents into a string
  string s {istreambuf_iterator<char>(ifs), 
            istreambuf_iterator<char>() };

  //output the size and content of the input file
  ...
  //create huffman tree based on the table
  HuffmanTree *htree = ... ;

  //now we can create code table based on the huffman tree
  codetable ctbl = ... ;

  //encode file content s according the code table
  code_t t = ... ;
  ...
  //output encoded file content t in a hex format
